<?php
  ...
  // Last modified: 07/27/2016, Lisa Wald
    if (!isset($TEMPLATE)) {
      $TITLE = '2015 Northstar Complex Fire - Colville Indian Reservation, Washington';
      $NAVIGATION = true;
      $HEAD = '
...
<div class="row">
  ...
  <div class="column one-of-two">
  	...
  	<ul>
  		<li><a href="ftp://hazards.cr.usgs.gov/web/postfire/2015/20150813northstar/PostFireDebrisFlowEstimates.gdb.zip">Geodatabase (.gdb)</a> (28.4MB Zip)</li>
  		<li><a href="ftp://hazards.cr.usgs.gov/web/postfire/2015/20150813northstar/Shapefiles.zip">Shapefile (.shp)</a> (20.4 Zip)</li>
