<?php
  ...
  // Last modified: 07/26/2016, Lisa Wald
    if (!isset($TEMPLATE)) {
      $TITLE = '2015 Rocky and Jerusalem Fires - Lake County, California';
      $NAVIGATION = true;
      $HEAD = '
...
<div class="row">
  ...
  <div class="column one-of-two">
  	...
  	<ul>
  		<li><a href="ftp://hazards.cr.usgs.gov/web/postfire/2015/20150729rockyjerusalem/PostFireDebrisFlowEstimates.gdb.zip">Geodatabase (.gdb)</a> (12.5MB Zip)</li>
  		<li><a href="ftp://hazards.cr.usgs.gov/web/postfire/2015/20150729rockyjerusalem/Shapefiles.zip">Shapefile (.shp)</a> (10.0MB Zipå)</li>
