<?php
  ...
  // Last modified: 07/27/2016, Lisa Wald
    if (!isset($TEMPLATE)) {
      $TITLE = '2015 Valley Fire - Lake County, California';
      $NAVIGATION = true;
      $HEAD = '
...
<div class="row">
  <div class="column one-of-two">
    <div class="alert">
  		<dl>
  			...
  			<dd>September 12, 2015</dd>

  			<dt>Location:</dt>
  			<dd>38.788, -122.624</dd>
  ...
  <div class="column one-of-two">
  	...
  	<ul>
  		<li><a href="ftp://hazards.cr.usgs.gov/web/postfire/2015/20150912valley/PostFireDebrisFlowEstimates.gdb.zip">Geodatabase (.gdb)</a> (7.9MB Zip)</li>
  		<li><a href="ftp://hazards.cr.usgs.gov/web/postfire/2015/20150912valley/Shapefiles.zip">Shapefile (.shp)</a> (6.6MB Zip)</li>
