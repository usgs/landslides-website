<?php
  ...
  // Last modified: 07/27/2016, Lisa Wald
    if (!isset($TEMPLATE)) {
      $TITLE = '2015 Clearwater Fire - Lewis, Clearwater, Idaho Counties, Idaho';
      $NAVIGATION = true;
      $HEAD = '
...
<div class="row">
  ...
  <div class="column one-of-two">
  	...
  	<ul>
  		<li><a href="ftp://hazards.cr.usgs.gov/web/postfire/2015/20150810clearwater/PostFireDebrisFlowEstimates.gdb.zip">Geodatabase (.gdb)</a> (5.6MB Zip)</li>
  		<li><a href="ftp://hazards.cr.usgs.gov/web/postfire/2015/20150810clearwater/Shapefiles.zip">Shapefile (.shp)</a> (5.1MB Zip)</li>
