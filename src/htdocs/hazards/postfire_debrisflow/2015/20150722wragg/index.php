<?php
  ...
  // Last modified: 07/26/2016, Lisa Wald
    if (!isset($TEMPLATE)) {
      $TITLE = '2015 Wragg Fire - Napa County, California';
      $NAVIGATION = true;
      $HEAD = '
...
<div class="row">
  ...
  <div class="column one-of-two">
  	...
  	<ul>
  		<li><a href="ftp://hazards.cr.usgs.gov/web/postfire/2015/20150722wragg/PostFireDebrisFlowEstimates.gdb.zip">Geodatabase (.gdb)</a> (1.2MB Zip)</li>
  		<li><a href="ftp://hazards.cr.usgs.gov/web/postfire/2015/20150722wragg/Shapefiles.zip">Shapefile (.shp)</a> (994kB Zip)</li>
