<?php
  ...
  // Last modified: 07/27/2016, Lisa Wald
    if (!isset($TEMPLATE)) {
      $TITLE = '2015 Black Canyon Fire - Okanogan and Wenatchee National Forests, Washington';
      $NAVIGATION = true;
      $HEAD = '
...
<div class="row">
  ...
  <div class="column one-of-two">
  	...
  	<ul>
  		<li><a href="ftp://hazards.cr.usgs.gov/web/postfire/2015/20150814blackcanyon/PostFireDebrisFlowEstimates.gdb.zip">Geodatabase (.gdb)</a> (9.2MB Zip)</li>
  		<li><a href="ftp://hazards.cr.usgs.gov/web/postfire/2015/20150814blackcanyon/Shapefiles.zip">Shapefile (.shp)</a> (6.8MB Zip)</li>
