<?php
  ...
  // Last modified: 07/26/2016, Lisa Wald
    if (!isset($TEMPLATE)) {
      $TITLE = '2015 Mad River Complex Fire - Trinity County, California';
      $NAVIGATION = true;
      $HEAD = '
...
<div class="row">
  ...
  <div class="column one-of-two">
  	...
  	<ul>
  		<li><a href="ftp://hazards.cr.usgs.gov/web/postfire/2015/20150730madriver/PostFireDebrisFlowEstimates.gdb.zip">Geodatabase (.gdb)</a> (4.5MB Zip)</li>
  		<li><a href="ftp://hazards.cr.usgs.gov/web/postfire/2015/20150730madriver/Shapefiles.zip">Shapefile (.shp)</a> (4.0MB Zip)</li>
