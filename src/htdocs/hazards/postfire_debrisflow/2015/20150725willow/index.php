<?php
  ...
  // Last modified: 07/26/2016, Lisa Wald
    if (!isset($TEMPLATE)) {
      $TITLE = '2015 Willow Fire - Sierra National Forest - Madera County, California';
      $NAVIGATION = true;
      $HEAD = '
  ...
  <div class="column one-of-two">
   ...
   <div class="column one-of-two">
      ...
      Below are the shapefiles and geodatabase information that was used in the creation of the maps on this page.
   	...
   	<ul>
   		<li><a href="ftp://hazards.cr.usgs.gov/web/postfire/2015/20150725willow/PostFireDebrisFlowEstimates.gdb.zip">Geodatabase (.gdb)</a> (1.1MB Zip)</li>
   		<li><a href="ftp://hazards.cr.usgs.gov/web/postfire/2015/20150725willow/Shapefiles.zip">Shapefile (.shp)</a> (983kB Zip)</li>
