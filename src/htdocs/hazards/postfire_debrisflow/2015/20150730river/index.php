<?php
  ...
  // Last modified: 07/26/2016, Lisa Wald
    if (!isset($TEMPLATE)) {
      $TITLE = '2015 River Complex Fire - Shasta-Trinity National Forest, California';
      $NAVIGATION = true;
      $HEAD = '
...
<div class="row">
  ...
  <div class="column one-of-two">
  	...
  	<ul>
  		<li><a href="ftp://hazards.cr.usgs.gov/web/postfire/2015/20150730river/PostFireDebrisFlowEstimates.gdb.zip">Geodatabase (.gdb)</a> (9.0MB Zip)</li>
  		<li><a href="ftp://hazards.cr.usgs.gov/web/postfire/2015/20150730river/Shapefiles.zip">Shapefile (.shp)</a> (6.8MB Zip)</li>
