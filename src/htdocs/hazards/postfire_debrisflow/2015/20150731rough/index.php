<?php
  ...
  // Last modified: 07/27/2016, Lisa Wald
    if (!isset($TEMPLATE)) {
      $TITLE = '2015 Rough Fire - Fresno County, California';
      $NAVIGATION = true;
      $HEAD = '
...
<div class="row">
  ...
  <div class="column one-of-two">
  	...
  	<ul>
  		<li><a href="ftp://hazards.cr.usgs.gov/web/postfire/2015/20150731rough/PostFireDebrisFlowEstimates.gdb.zip">Geodatabase (.gdb)</a> (20.7MB Zip)</li>
  		<li><a href="ftp://hazards.cr.usgs.gov/web/postfire/2015/20150731rough/Shapefiles.zip">Shapefile (.shp)</a> (16.2MB Zip)</li>
