<?php
  ...
  // Last modified: 07/26/2016, Lisa Wald
    if (!isset($TEMPLATE)) {
      $TITLE = '2015 Saddle Fire - Trinity County, California';
      $NAVIGATION = true;
      $HEAD = '
...
<div class="row">
  ...
  <div class="column one-of-two">
  	...
  	<ul>
  		<li><a href="ftp://hazards.cr.usgs.gov/web/postfire/2015/20150609saddle/PostFireDebrisFlowEstimates.gdb.zip">Geodatabase (.gdb)</a> (380kB Zip)</li>
  		<li><a href="ftp://hazards.cr.usgs.gov/web/postfire/2015/20150609saddle/Shapefiles.zip">Shapefile (.shp)</a> (392kB Zip)</li>
