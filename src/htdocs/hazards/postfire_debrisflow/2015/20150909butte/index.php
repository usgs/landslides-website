<?php
  ...
  // Last modified: 07/27/2016, Lisa Wald
    if (!isset($TEMPLATE)) {
      $TITLE = '2015 Butte Fire - Amador and Calaveras Counties, California';
      $NAVIGATION = true;
      $HEAD = '
...
<div class="row">
  ...
  <div class="column one-of-two">
  	...
  	<ul>
  		<li><a href="ftp://hazards.cr.usgs.gov/web/postfire/2015/20150909butte/PostFireDebrisFlowEstimates.gdb.zip">Geodatabase (.gdb)</a> (9.5MB Zip)</li>
  		<li><a href="ftp://hazards.cr.usgs.gov/web/postfire/2015/20150909butte/Shapefiles.zip">Shapefile (.shp)</a> (7.9MB Zip)</li>
