<?php
  ...
  // Last modified: 07/26/2016, Lisa Wald
    if (!isset($TEMPLATE)) {
      $TITLE = '2015 Lake Fire - San Bernardino National Forest - San Bernardino County, California';
      $NAVIGATION = true;
      $HEAD = '
...
<div class="row">
  ...
  <div class="column one-of-two">
  	...
  	<ul>
  		<li><a href="ftp://hazards.cr.usgs.gov/web/postfire/2015/20150617lake/PostFireDebrisFlowEstimates.gdb.zip">Geodatabase (.gdb)</a> (6.3MB Zip)</li>
  		<li><a href="ftp://hazards.cr.usgs.gov/web/postfire/2015/20150617lake/Shapefiles.zip">Shapefile (.shp)</a> (3.9MB Zip)</li>
