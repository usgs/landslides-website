<?php
  ...
  // Last modified: 07/27/2016, Lisa Wald
    if (!isset($TEMPLATE)) {
      $TITLE = '2015 Tepee Springs Fire - Idaho County, Idaho';
      $NAVIGATION = true;
      $HEAD = '
...
<div class="row">
  ...
  <div class="column one-of-two">
  	...
  	<ul>
  		<li><a href="ftp://hazards.cr.usgs.gov/web/postfire/2015/20150812tepeesprings/PostFireDebrisFlowEstimates.gdb.zip">Geodatabase (.gdb)</a></li>
  		<li><a href="ftp://hazards.cr.usgs.gov/web/postfire/2015/20150812tepeesprings/Shapefiles.zip">Shapefile (.shp)</a></li>
