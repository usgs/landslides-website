<?php
  ...
  // Last modified: 07/26/2016, Lisa Wald
    if (!isset($TEMPLATE)) {
      $TITLE = '2015 Stouts Creek Fire - Douglas County, Oregon';
      $NAVIGATION = true;
      $HEAD = '
...
<div class="row">
  ...
  <div class="column one-of-two">
  	...
  	<ul>
  		<li><a href="ftp://hazards.cr.usgs.gov/web/postfire/2015/20150730stoutscreek/PostFireDebrisFlowEstimates.gdb.zip">Geodatabase (.gdb)</a> (6.4MB Zip)</li>
  		<li><a href="ftp://hazards.cr.usgs.gov/web/postfire/2015/20150730stoutscreek/Shapefiles.zip">Shapefile (.shp)</a> (5.0MB Zip)</li>
