<?php
  ...
  // Last modified: 07/27/2016, Lisa Wald
    if (!isset($TEMPLATE)) {
      $TITLE = '2015 Municipal Fire - Clearwater County, Idaho';
      $NAVIGATION = true;
      $HEAD = '
...
<div class="row">
  <div class="column one-of-two">
    <div class="alert">
  		<dl>
  			...
  			<dd>August 18, 2015</dd>

  			<dt>Location:</dt>
  			<dd>46.467, -116.239</dd>
  ...
  <div class="column one-of-two">
  	...
  	<ul>
  		<li><a href="ftp://hazards.cr.usgs.gov/web/postfire/2015/20150818municipal/PostFireDebrisFlowEstimates.gdb.zip">Geodatabase (.gdb)</a> (314kB Zip)</li>
  		<li><a href="ftp://hazards.cr.usgs.gov/web/postfire/2015/20150818municipal/Shapefiles.zip">Shapefile (.shp)</a> (518kB Zip)</li>
