<?php
  ...
  // Last modified: 07/27/2016, Lisa Wald
    if (!isset($TEMPLATE)) {
      $TITLE = '2015 Solimar Fire - Ventura County, California';
      $NAVIGATION = true;
      $HEAD = '
...
<div class="row">
  <div class="column one-of-two">
    <div class="alert">
  		<dl>
  			...
  			<dd>December 26, 2015</dd>

  			<dt>Location:</dt>
  			<dd>34.304, -119.339</dd>
  ...
  <div class="column one-of-two">
  	...
  	<ul>
  		<li><a href="ftp://hazards.cr.usgs.gov/web/postfire/2015/20151226solimar/PostFireDebrisFlowEstimates.gdb.zip">Geodatabase (.gdb)</a> (244kB Zip)</li>
  		<li><a href="ftp://hazards.cr.usgs.gov/web/postfire/2015/20151226solimar/Shapefiles.zip">Shapefile (.shp)</a> (227kB Zip)</li>
