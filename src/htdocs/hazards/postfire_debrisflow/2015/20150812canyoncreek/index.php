<?php
  ...
  // Last modified: 07/27/2016, Lisa Wald
    if (!isset($TEMPLATE)) {
      $TITLE = '2015 Canyon Creek Fire - Malheur National Forest, Oregon';
      $NAVIGATION = true;
      $HEAD = '
...
<div class="row">
  <div class="column one-of-two">
    <div class="alert">
  		<dl>
  			...
  			<dd>August 12, 2015</dd>

  			<dt>Location:</dt>
  			<dd>44.284, -118.961</dd>
  ...
  <div class="column one-of-two">
  	...
  	<ul>
  		<li><a href="ftp://hazards.cr.usgs.gov/web/postfire/2015/20150812canyoncreek/PostFireDebrisFlowEstimates.gdb.zip">Geodatabase (.gdb)</a> (12.3MB Zip)</li>
  		<li><a href="ftp://hazards.cr.usgs.gov/web/postfire/2015/20150812canyoncreek/Shapefiles.zip">Shapefile (.shp)</a> (9.4MB Zip)</li>
