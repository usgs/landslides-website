<?php
  ...
  // Last modified: 07/27/2016, Lisa Wald
    if (!isset($TEMPLATE)) {
      $TITLE = '2015 Twisp River Fire - Okanogan County, Washington';
      $NAVIGATION = true;
      $HEAD = '
...
<div class="row">
  ...
  <div class="column one-of-two">
  	...
  	<ul>
  		<li><a href="ftp://hazards.cr.usgs.gov/web/postfire/2015/20150814twispriver/PostFireDebrisFlowEstimates.gdb.zip">Geodatabase (.gdb)</a> (1.1MB Zip)</li>
  		<li><a href="ftp://hazards.cr.usgs.gov/web/postfire/2015/20150814twispriver/Shapefiles.zip">Shapefile (.shp)</a> (899kB Zip)</li>
