<?php
  ...
  // Last modified: 07/25/2016, Lisa Wald
    if (!isset($TEMPLATE)) {
      $TITLE = '2014 Chiwaukum Complex Fire - Chelan County, Washington';
      $NAVIGATION = true;
      $HEAD = '
...
<div class="row">
  ...
  <div class="column one-of-two">
  	...
  	<ul>
  		<li><a href="ftp://hazards.cr.usgs.gov/web/postfire/2014/20140715chiwaukum/PostFireDebrisFlowEstimates.gdb.zip">Geodatabase (.gdb)</a> (4.6MB Zip)</li>
  		<li><a href="ftp://hazards.cr.usgs.gov/web/postfire/2014/20140715chiwaukum/Shapefiles.zip">Shapefile (.shp)</a>(3.4MB Zip)</li>
