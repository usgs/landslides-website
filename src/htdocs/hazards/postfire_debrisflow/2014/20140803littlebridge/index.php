<?php
  ...
  // Last modified: 07/25/2016, Lisa Wald
    if (!isset($TEMPLATE)) {
      $TITLE = '2014 Little Bridge Creek Fire - Okanogan County, Washington';
      $NAVIGATION = true;
      $HEAD = '
...
<div class="row">
  ...
  <div class="ten column downloads">
  	...
  	<ul>
  		<li><a href="ftp://hazards.cr.usgs.gov/web/postfire/2014/20140803littlebridge/PostFireDebrisFlowEstimates.gdb.zip">Geodatabase (.gdb)</a> (1.3MB Zip)</li>
  		<li><a href="ftp://hazards.cr.usgs.gov/web/postfire/2014/20140803littlebridge/Shapefiles.zip">Shapefile (.shp)</a> (1.1MB Zip)</li>
