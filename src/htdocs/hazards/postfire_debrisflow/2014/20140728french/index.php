<?php
  ...
  // Last modified: 07/25/2016, Lisa Wald
    if (!isset($TEMPLATE)) {
      $TITLE = '2014 French Fire - Madera County, California';
      $NAVIGATION = true;
      $HEAD = '
...
<div class="row">
  ...
  <div class="column one-of-two">
  	...
  	<ul>
  		<li><a href="ftp://hazards.cr.usgs.gov/web/postfire/2014/20140728french/PostFireDebrisFlowEstimates.gdb.zip">Geodatabase (.gdb)</a> (3.1MB Zip)</li>
  		<li><a href="ftp://hazards.cr.usgs.gov/web/postfire/2014/20140728french/Shapefiles.zip">Shapefile (.shp)</a> (2.7MB Zip)</li>
