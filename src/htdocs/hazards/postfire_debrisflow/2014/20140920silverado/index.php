<?php
  ...
  // Last modified: 07/25/2016, Lisa Wald
    if (!isset($TEMPLATE)) {
      $TITLE = '2014 Silverado Fire - Orange County, California';
      $NAVIGATION = true;
      $HEAD = '
...
<div class="row">
  ...
  <div class="column one-of-two">
  	...
  	<ul>
  		<li><a href="ftp://hazards.cr.usgs.gov/web/postfire/2014/20140920silverado/PostFireDebrisFlowEstimates.gdb.zip">Geodatabase (.gdb) (300kB Zip)</a></li>
  		<li><a href="ftp://hazards.cr.usgs.gov/web/postfire/2014/20140920silverado/Shapefiles.zip">Shapefile (.shp)</a> (277kB Zip)</li>
