<?php
  ...
  // Last modified: 07/25/2016, Lisa Wald
    if (!isset($TEMPLATE)) {
      $TITLE = '2014 Duncan Fire - Chelan County, Washington';
      $NAVIGATION = true;
      $HEAD = '
...
<div class="row">
  ...
  <div class="column one-of-two">
  	...
  	<ul>
  		<li><a href="ftp://hazards.cr.usgs.gov/web/postfire/2014/20140716duncan/PostFireDebrisFlowEstimates.gdb.zip">Geodatabase (.gdb)</a> (4.0MB Zip)</li>
  		<li><a href="ftp://hazards.cr.usgs.gov/web/postfire/2014/20140716duncan/Shapefiles.zip">Shapefile (.shp)</a> (3.4MB Zip)</li>
