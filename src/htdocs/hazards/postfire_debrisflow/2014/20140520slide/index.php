<?php
  ...
  // Last modified: 07/25/2016, Lisa Wald
    if (!isset($TEMPLATE)) {
      $TITLE = '2014 Slide Fire - Coconino/Yavapai Counties, Arizona';
      $NAVIGATION = true;
      $HEAD = '
...
<div class="row">
  ...
  <div class="column one-of-two">
  	...
  	<ul>
  		<li><a href="ftp://hazards.cr.usgs.gov/web/postfire/2014/20140520slide/PostFireDebrisFlowEstimates.gdb.zip">Geodatabase (.gdb)</a></li>
  		<li><a href="ftp://hazards.cr.usgs.gov/web/postfire/2014/20140520slide/Shapefiles.zip">Shapefile (.shp)</a></li>
