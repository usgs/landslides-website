<?php
  ...
  // Last modified: 07/27/2016, Lisa Wald
    if (!isset($TEMPLATE)) {
      $TITLE = '2016 Sherpa Fire - Los Padres National Forest, California';
      $NAVIGATION = true;
      $HEAD = '
...
<div class="row">
  ...
  <div class="column one-of-two">
  	...
  	<ul>
  		<li><a href="ftp://hazards.cr.usgs.gov/web/postfire/2016/20160615sherpa/PostFireDebrisFlowEstimates.zip">Geodatabase (.gdb)</a> (3.1MB Zip)</li>
  		<li><a href="ftp://hazards.cr.usgs.gov/web/postfire/2016/20160615sherpa/Shapefiles.zip">Shapefile (.shp)</a> (1.5MB Zip)</li>
