<?php
  ...
  // Last modified: 07/27/2016, Lisa Wald
    if (!isset($TEMPLATE)) {
      $TITLE = '2016 Dog Head Fire - Bernalillo County, New Mexico';
      $NAVIGATION = true;
      $HEAD = '
...
<div class="row">
  ...
  <div class="column one-of-two">
  	...
  	<ul>
  		<li><a href="ftp://hazards.cr.usgs.gov/web/postfire/2016/20160614doghead/PostFireDebrisFlowEstimates.zip">Geodatabase (.gdb)</a> (5.4MB Zip)</li>
  		<li><a href="ftp://hazards.cr.usgs.gov/web/postfire/2016/20160614doghead/Shapefiles.zip">Shapefile (.shp)</a> (5.3MB Zip)</li>
