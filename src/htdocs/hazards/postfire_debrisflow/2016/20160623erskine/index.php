<?php
  ...
  // Last modified: 07/27/2016, Lisa Wald
    if (!isset($TEMPLATE)) {
      $TITLE = '2016 Erskine Fire - Kern County, CA';
      $NAVIGATION = true;
      $HEAD = '
...
<div class="row">
  ...
  <div class="column one-of-two">
  	...
  	<ul>
  		<li><a href="ftp://hazards.cr.usgs.gov/web/postfire/2016/20160623erskine/PostFireDebrisFlowEstimates.zip">Geodatabase (.gdb)</a> (15.7MB Zip)</li>
  		<li><a href="ftp://hazards.cr.usgs.gov/web/postfire/2016/20160623erskine/Shapefiles.zip">Shapefile (.shp)</a> 8.2MB Zip</li>
