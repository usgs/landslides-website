...
<h2>What To Do Before a Landslide</h2>
	<ul class="separator">
		...
		<li>Minimize home hazards:
			<ul>
		          ...
		          <li>In mudflow areas, build channels or deflection walls to direct the flow around buildings.  <em>Remember</em>: If you build walls to divert debris flow and the flow lands on a neighbor's property, you may be liable for damages.</li>
			</ul>
		</li>
	</ul>


<h2>What To Do During a Landslide</h2>
	<ul class="separator">
		<li>Stay alert and awake. Many debris-flow fatalities occur when people are sleeping. Listen to a NOAA Weather Radio or portable, battery-powered radio or television for warnings of intense rainfall. Be aware that intense, short bursts of rain may be particularly dangerous, especially after longer periods of heavy rainfall and damp weather.</li>

		<li>If you are in areas susceptible to landslides and debris flows, consider leaving if it is safe to do so. Remember that driving during an intense storm can be hazardous. If you remain at home, move to a second story if possible. Staying out of the path of a landslide or debris flow saves lives.</li>

		<li>Listen for any unusual sounds that might indicate moving debris, such as trees cracking or boulders knocking together. A trickle of flowing or falling mud or debris may precede larger landslides. Moving debris can flow quickly and sometimes without warning.</li>
...
<h2>What to Do if You Suspect Imminent Landslide Danger</h2>
	<ul class="separator">
...
<h2>What To Do After a Landslide</h2>
	<ul class="separator">
		...
		<li>Help a neighbor who may require special assistance - infants, elderly people, and people with disabilities. Elderly people and people with disabilities may require additional assistance. People who care for them or who have large families may need additional assistance in emergency situations.</li>
