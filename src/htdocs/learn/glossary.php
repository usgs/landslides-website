...
<nav class="jumplist">
  ...
  <a href="#g">G</a>
  <a href="#h">H</a>
  <a style="text-decoration:none"><font color="black">I</font></a>
  <a style="text-decoration:none"><font color="black">J</font></a>
  <a style="text-decoration:none"><font color="black">K</font></a>
  <a href="#l">L</a>
  <a href="#m">M</a>
  <a style="text-decoration:none"><font color="black">N</font></a>
  <a style="text-decoration:none"><font color="black">O</font></a>
  <a href="#p">P</a>
  <a style="text-decoration:none"><font color="black">Q</font></a>
  <a href="#r">R</a>
  <a href="#s">S</a>
  <a href="#t">T</a>
  <a style="text-decoration:none"><font color="black">U</font></a>
  <a href="#v">V</a>
  <a href="#w">W</a>
  <a style="text-decoration:none"><font color="black">X</font></a>
  <a style="text-decoration:none"><font color="black">Y</font></a>
  <a href="#z">Z</a>
...
<h2 id="b">B</h2>
<dl>
  <dt>bedding suface/plane</dt>
    <dd>
    bedding suface/plane - in sedimentary or stratified rocks, the division planes which separate each successive layer or bed from the one above or below. It commonly marks a visible change in lithology or color.  (<a href="http://www.americangeosciences.org/">American Geological Institute (AGI))</a>
    </dd>
  <dt>bedrock</dt>
    <dd>
...
<h2 id="c">C</h2>
<dl>
<dt>catch basin <font style="font-weight:normal"> - see - </font>debris basin</dt>
  <dt> check dams</dt>
    <dd>
...
<h2 id="d">D</h2>
<dl>
  <dt>debris basin<font style="font-weight:normal"> - sometimes called - </font>catch basin</dt>
    <dd>
  ...
  <dt>digital elevation model (DEM)</dt>
    <dd>
  ...
  <dt>digital terrain model  (DTM)</dt>
    <dd>
...
<h2 id="e">E</h2>
<dl>
  <dt>electronic distance meter (EDM)</dt>
    <dd>
...
<dl>
  ...
  <dt>landslide inventory maps</dt>
    <dd>
  ...
  <dt>landslide susceptibility map</dt>
    <dd>
  ...
  <dt>LIDAR (<u>Li</u>ght <u>D</u>etection <u>a</u>nd <u>R</u>anging, also known as Airborne Laser Swath Mapping or ALSM)</dt>
    <dd>
     a technology that employs an airborne scanning laser rangefinder to produce detailed and accurate topographic surveys. LIDAR can be used to accurately measure the topography of the ground, even where overlying vegetation is quite dense. (see <a href="http://pugetsoundlidar.ess.washington.edu/" target="_blank">Puget Sound LIDAR Consortium</a>)
    </dd>
  <dt>liquefaction</dt>
    <dd>
...
<dl>
  ...
  <dt>mudslide</dt>
    <dd>
    an imprecise but popular term coined in California, USA, frequently used by laymen and the news media to describe a wide scope of events, ranging from debris-laden floods to landslides.  Not technically correct.  Please see <strong>mudflow</strong>, previous glossary entry.  CO Survey, 1988.
    </dd>
</dl>

<h2 id="p">P</h2>
<dl>
  <dt>perched ground water</dt>
    <dd>
    unconfined ground water separated from the underlying main body of ground water by unsaturated rock.  AGI
    </dd>
  <dt>pore water pressure</dt>
    <dd>
  ...
  <dt>pore water<font style="font-weight:normal">, or </font> interstitial water</dt>
    <dd>
...
<dl>
  <dt>sag pond</dt>
    <dd>
    a small body of water occupying an enclosed depression or sag formed where active or recent fault movement has impounded drainage.  AGI</p>
    </dd>
  <dt>sea cliff retreat</dt>
    <dd>
    a cliff formed by wave action, causing the coastal cliff to erode and recede towards land.  AGI</p>
    </dd>
  <dt>seepage</dt>
    <dd>
    and concentrated subsurface drainage are indicated by springs, sag ponds, or moist areas on open slopes, and seepage sites along road cuts.  The locations of these areas of concentrated subsurface flow should be noted on maps and profiles as potential sites of active, unstable ground.  Chatwin and others, 1994.</p>
    </dd>
  <dt>shear</dt>
    <dd>
    a deformation resulting from stresses that cause contiguous parts of a body to slide relatively to each other in a direction parallel to their plane of contact.  AGI</p>
    </dd>
  <dt>slurry</dt>
    <dd>
    a highly fluid mixture of water and finely divided material; for example, pulverized coal and water for movement by pipeline, or of cement and water for use in grouting.  AGI</p>
    </dd>
  <dt>soil mechanics</dt>
    <dd>
    the application of the principles of mechanics and hydraulics to engineering problems dealing with the behavior and nature of soils, sediments, and other unconsolidated accumulations; the study of the physical properties and utilization of soils, especially in relation to highway and foundation engineering.  AGI</p>
    </dd>
  <dt>stress</dt>
    <dd>
    in a solid, the force per unit area, acting on any surface within it, and variously expressed as pounds or tons per square inch, or dynes or kilograms per square centimeter; also, by extension, the external pressure which creates the internal force.  AGI</p>
    </dd>
  <dt>sturzstroms</dt>
    <dd>
    German for "fall stream". A huge mass of rapidly moving rock debris and dust, derived from the collapse of a cliff or mountainside, flowing down steep slopes and across low ground, often for several kilometers at speeds of more than 100 km/hr.  Sturzstroms are the most catastrophic of all forms of mass movement.</p>
    </dd>
  <dt>submarine and subaqueous landslide</dt>
    <dd>
    deposits that occur from landslide processes under water.  Submarine landslides can be for example, block slides, flow slides, mud slides.  Large underwater landslides can displace water, sometimes rapidly, and cause tsunamis.  Garrison and Sangrey, USGS, 1990.</p>
    </dd>
  <dt>subsidence</dt>
    <dd>
    sinking or downward settling of the earth's surface, not restricted in rate, magnitude, or area involved.  Subsidence may be caused by natural geologic processes, such as solution, compaction, or withdrawal of fluid lava from beneath a solid crust; man's activity such as subsurface mining or the pumping of oil or ground water may also cause subsidence.  AGI</p>
    </dd>
  <dt>surficial geology</dt>
    <dd>
    geology of surficial deposits, including soils; the term is sometimes applied to the study of bedrock at or near the earth's surface.  AGI</p>
    </dd>
  <dt>swelling soils</dt>
    <dd>
    soils or soft bedrock which increase in volume as they get wet and shrink as they dry out.  They are also commonly known as bentonite, expansive, or montmorillinitic soils.</p>
    </dd>
</dl>

<h2 id="t">T</h2>
<dl>
  <dt>tensile stress</dt>
    <dd>
    a normal stress that tends to pull apart the material on the opposite sides of the plane on which it acts.  AGI</p>
    </dd>
</dl>
...
<dl>
  <dt>vulnerability assessment</dt>
    <dd>
    the susceptibility or exposure to injury or loss from a hazard.</p>
    </dd>
</dl>
...
<dl>
  <dt>weathering</dt>
    <dd>
    the destructive process by which earth and rock materials exposed to the atmosphere undergo physical disintegration and chemical decomposition resulting in changes in color, texture, composition, or form.  Processes may be physical, chemical, or biological.</p>
    </dd>
  <dt>Differential Weathering</dt>
    <dd>
    when weathering across a rock face or exposure occurs at different rates; mainly due to variations in the composition and resistance of the rock.  This results in an uneven surface with the more resistant material protruding.</p>
    </dd>
  <dt>Mechanical Weathering</dt>
    <dd>
    the physical processes by which rocks exposed to the weather change in character, decay, and crumble into soil.  Processes include temperature change (expansion and shrinkage), freeze-thaw cycle, and the burrowing activity of animals.  CO Landslide Mitigation Plan</p>
    </dd>
<dl>
...
<ul class="referencelist">
  <li>Bates, Robert L., and Julia A. Jackson, Eds., 1984, Dictionary of
    Geological Terms, 3rd Edition, prepared by the American Geological
    Institute, Doubleday.
  </li>

  <li>Shelton, David C., and Dick Prouty, 1979, Nature's Building
    Codes,Geology and Construction in Colorado, Colorado Geological
    Survey Special Publication 12.
  </li>

  <li>Creath, W.B, 1996, Homebuyers' Guide to Geologic Hazards:
    An AIPG Issues and Answers Publication, Colorado Geological Survey,
    Miscellaneous Publication
  </li>


  <li>Chatwin, S.C., Howes, D.E., Schwab, J.W., and D.N. Swanston, 1994, A Guide
  ...
  <li>Jochim, Candice L., Rogers William P., Truby, John O., Wold, Robert L. Jr.,
