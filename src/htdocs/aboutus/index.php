...
<div class="row">
  ...
  <div class="column one-of-two">
    ...
    <h2>The Landslide Hazards Program Long-term Goals</h2>
    <p>
    ...
    <ul>
      <li>Conduct landslide hazard assessments</li>
      <li>Monitor and model active landslides</li>
      <li>Provide pre - and post - landslide hazard event assessments</li>
