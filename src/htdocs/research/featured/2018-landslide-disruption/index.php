...
<figure class="right">
  ...
  <figcaption>
    Map of Puget Sound Washington, showing location of the field site in Mukilteo. The gray hillshade inset shows a digital elevation map with the location of the two hillslope monitoring sites, labeled LS and VH.
  </figcaption>
</figure>
...
<figure class="left">
  <img src="images/2slopes.jpg" alt=""/>
  <figcaption>
...
<div class='row'>
  <div class='column one-of-three'>
    ...
    <p>
      <a href="https://www.usgs.gov/staff-profiles/ben-mirus?qt-staff_profile_science_products=3#qt-staff_profile_science_products">Ben Mirus</a> started his career with the USGS in 2005, then served as an assistant professor at UNC Chapel Hill, and was excited to return to the USGS in 2015 to study landslide hazards. In his free time Ben enjoys snowboarding, playing board games, and walking the family dogs.
    </p>
  </div>
  <div class='column one-of-three'>
    <figure class="left">
      <img src="images/Rex-Baum.png" alt=""/>
      <figcaption>
        Rex Baum.
      </figcaption>
    </figure>
    ...
    <p>
      <a href="https://www.usgs.gov/staff-profiles/rex-baum?qt-staff_profile_science_products=3#qt-staff_profile_science_products">Rex Baum</a> has been a geologist with the USGS for more than three decades, where he studies landslide processes, hazards, and warning.  Rex enjoys the outdoors along with many other interests.
    </p>
