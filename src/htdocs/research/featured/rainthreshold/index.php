...
<p class="sidebar">
  "Statistically" means that they were able to plug in all the data into an equation that successfully and consistently distinguished conditons of high probability of shallow landslides compared to conditions of low probability.
</p>
<p>
...
<ol>
  ...
  <li>
    an estimate of the amount of moisture that had evaporated from the ground in those weeks,
  </li>
  <li>
...
<p>
<img class="component gage" src="images/rainfall-amt.png">
<img class="component" src="images/soil-moisture.png">
<img class="component" src="images/subsurface-drainage.png">
<img class="component" src="images/intensity.png">
...
<p>
  A <strong><a href="https://landslides.usgs.gov/monitoring/seattle/images/idthresh.jpg">precipitation threshold</a></strong> is determined from these storm rainfall data, and is defined as the intensity level for a given duration at which a landslide in the area may be triggered.  This method can be used relatively inexpensively in other areas where landslides pose a risk. Even so, historical rainfall and landslide data are needed to calibrate the threshold for each new area.  In recent years scientists have calibrated landslide thresholds for various areas across the country and around the world.
</p>
<img style="float:right;" src="images/rainfall-intensity.png">
<p>
  One factor that isn’t measured in this method (intensity-duration thresholds) that influences the triggering of landslides is the amount of moisture in the ground at differing depths. In one approach, data about the rainfall, evaporation, and drainage in the weeks before the storm are fed into a simple model to estimate the moisture in the ground. This model, called the <a href="/monitoring/seattle/rtdmonitoring.php#nws-wet"<strong>Antecedent Wetness Index</strong></a>, helps identify times when the ground is wet enough to expect landslides. Having actual measurements of soil-moisture saturation and pore pressures would help scientists pin down the timing of potential landslides better, and it’s the focus of <a href="/research/rtmonitoring/">current research </a>in several landslide-prone parts of the country.
</p>
