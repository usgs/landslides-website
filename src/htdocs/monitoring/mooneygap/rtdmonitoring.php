...
<h2 id="rainfall">Rainfall</h2>
  ...
  Gauge</h3>
  <img
  src="http://landslides.usgs.gov/realtime/plots/ncMooneyGap_precip_twoWeek.png">
  </div>
...
<h2 id="ground">Groundwater Pressure</h2>
  ...
  <div align="center">
  	...
  	<img src="http://landslides.usgs.gov/realtime/plots/ncMooneyGap_porePressure_twoWeek.png">
  </div>
...
<h2 id="soilwater">Soil Water Content</h2>
  ...
  <img
  src="http://landslides.usgs.gov/realtime/plots/ncMooneyGap_vWC_twoWeek.png">
  </div>
...
<h2 id="soiltemp">Soil Temperature</h2>
  ...
  <img
  src="http://landslides.usgs.gov/realtime/plots/ncMooneyGap_soilTemp_twoWeek.png">
  </div>
...
<h2 id="battery">Battery Voltage</h2>
  ...
  <img
  src="http://landslides.usgs.gov/realtime/plots/ncMooneyGap_batteryTemp_twoWeek.png">
  </div>
