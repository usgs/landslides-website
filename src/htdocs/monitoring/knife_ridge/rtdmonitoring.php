...
<h2 id="ground">Ground Water Pressure (Tensiometers and Pressure Tranducers)</h2>
  ...
  <h2 id="pres">Ground-water and Atmospheric Pressure - Piezometers</h2>
    ...
    <img src="//landslides.usgs.gov/realtime/plots/Elliott_Pore_Pressure_PZ.elliott_pore_pressure_pz.png" alt="Graph of pore pressure for past week" />
...
<h2 id="soiltemp">Soil Temperature</h2>
  ...
  <img
  src="//landslides.usgs.gov/realtime/plots/Elliott_Temperature_1.elliott_temperature_1.png" alt="Graph of soil temperature for past 7 days" />
  <img
  src="//landslides.usgs.gov/realtime/plots/Elliott_Temperature_2.elliott_temperature_2.png" alt="Graph of soil temperature for past 7 days" />
...
<p>Battery voltage is monitored for identifying problems with the power system due to solar panel or battery failures.</p>
  ...
  <img src="//landslides.usgs.gov/realtime/plots/Elliott_Battery.elliott_battery.png" alt="Graph of battery voltage for past 7 days" />
