...
<h2 id="rainfall">Rainfall</h2>
  ...
  <img src="/realtime/plots/Elliott_Rainfall.elliott_rainfall.png"
...
<h2 id="ground">Ground Water Pressure (Tensiometers and Pressure Tranducers)</h2>
  ...
  <h2 id="ten">Ground Water Pressure - Tensionmeters</h2>
    ...
    <img src="/realtime/plots/Elliott_Pore_Pressure_1.elliott_pore_pressure_1.png"
        alt="Graph of last 14 days" /><br/>
    <img
    src="/realtime/plots/Elliott_Pore_Pressure_2.elliott_pore_pressure_2.png"
  ...
  <h2 id="pres">Ground-water and Atmospheric Pressure - Piezometers</h2>
    ...
    <img src="/realtime/plots/Elliott_Pore_Pressure_PZ.elliott_pore_pressure_pz.png" alt="Graph of pore pressure for past week" />
...
<h2 id="soiltemp">Soil Temperature</h2>
  ...
  <img
  src="/realtime/plots/Elliott_Temperature_1.elliott_temperature_1.png" alt="Graph of soil temperature for past 7 days" />
  <img
  src="/realtime/plots/Elliott_Temperature_2.elliott_temperature_2.png" alt="Graph of soil temperature for past 7 days" />
...
<h2 id="soilwater">Soil Water Content</h2>
  ...
  <img
  src="/realtime/plots/Elliott_Watercontent1.elliott_watercontent1.png" alt="Graph of water content for past 7 days" /><br/>
  <img
  src="/realtime/plots/Elliott_Watercontent2.elliott_watercontent2.png" alt="Graph of water content for past 7 days" />
...
<p>Battery voltage is monitored for identifying problems with the power system due to solar panel or battery failures.</p>
  ...
  <img src="/realtime/plots/Elliott_Battery.elliott_battery.png" alt="Graph of battery voltage for past 7 days" />
