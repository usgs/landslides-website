...
-->
    ...
    <p>
      Data from the sensors are sampled at <strong>high rates (2 seconds to 100 hertz) during rain events and every 2 minutes otherwise</strong>. Two-minute data are transmitted by cell phone modem from the site to a USGS computer <strong>every 5 minutes</strong>. After transmission, the data are graphed and placed on a web server available to the public.
    </p>
    <p>
      Typically the most recent data on the graph lags the current time by about 5 minutes.  Updates may be interrupted occasionally by instrument, computer, or network malfunctions.
    </p>
