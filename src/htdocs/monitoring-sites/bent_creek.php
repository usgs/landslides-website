<?php
      ...
      if  (!isset($TEMPLATE))  {
      $TITLE  =  'Bent Creek Experimental Forest, North Carolina - Recent Conditions';
      $NAVIGATION  = true;
...
<h2 id="rainfall">Rainfall</h2>
  ...
  <div align="center">
    <h3>Rainfall over the last 14 days at Bent Creek Rain Gauge</h3>
    <img
    src="/static/landslides-realtime/plots/ncBentCreek_precip_twoWeek.png">
  </div>
...
<h2 id="ground">Ground Water Pressure</h2>
  ...
  <div align="center">
  	...
  	<img
		src="/static/landslides-realtime/plots/ncBentCreek_porePressure_twoWeek.png">
  </div>
...
<h2 id="soilwater">Soil Water Content</h2>
  ...
  <div align="center">
    ...
    <img
    src="/static/landslides-realtime/plots/ncBentCreek_vWC_twoWeek.png">
  </div>
...
<h2 id="soiltemp">Soil Temperature</h2>
  ...
  <div align="center">
    ...
    <img
    src="/static/landslides-realtime/plots/ncBentCreek_soilTemp_twoWeek.png">
  </div>
...
<h2 id="battery">Battery Voltage</h2>
  ...
  <div align="center">
    ...
    <img
    src="/static/landslides-realtime/plots/ncBentCreek_batteryTemp_twoWeek.png">
  </div>
